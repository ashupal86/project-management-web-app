...
Revision ID: 2f78e048b169
Revises: 
Create Date: 2024-11-15 21:57:05.193487
...
def upgrade():
    ...
    sa.Column('group_code', sa.String(length=4), nullable=False),
    ...
    sa.ForeignKeyConstraint(['created_by'], ['student.id'], ),
